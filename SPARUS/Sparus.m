...
% Appendages
MIa1C = [mass_matrix(Ma1) zeros(3) ;
        zeros(3) Ia1];
MIa2C = [mass_matrix(Ma2) zeros(3) ;
        zeros(3) Ia2];
MIa3C = [mass_matrix(Ma3) zeros(3) ;
        zeros(3) Ia3];
MIa4C = [mass_matrix(Ma4) zeros(3) ;
        zeros(3) Ia4];
...
MI_Total = MIfb+MImb+MIab+MIa1+MIa2+MIa3+MIa4+MIthl+MIthr
...
AMM_Total = AMMG + AMM1 + AMM2 + AMM3 + AMM4
